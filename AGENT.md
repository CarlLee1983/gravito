...
This file provides comprehensive guidance and context for AI Agents working with the Gravito repository.
...
- **[Whitepaper](./docs/whitepaper/gravito-whitepaper-zh-tw.md)**：Galaxy Architecture 設計白皮書
- **[Gravito Agent Guide](./docs/guides/ai/gravito-agent-guide.md)**：AI Agent 開發指南
- **[Operations Guides](./docs/operations/)**：詳細操作指南
