...
export const shardingConfig: ShardingConfig = {
  ...
  shards: [
    ...
    },
    {
      ...
      port: parseInt(process.env.SHARD_1_PORT || '5433'),
    ...
    },
    {
      ...
      port: parseInt(process.env.SHARD_2_PORT || '5434'),
    ...
    },
    {
      ...
      port: parseInt(process.env.SHARD_3_PORT || '5435'),
    ...
    },
    {
      ...
      port: parseInt(process.env.SHARD_4_PORT || '5436'),
    ...
    },
    {
      ...
      port: parseInt(process.env.SHARD_5_PORT || '5437'),
    ...
    },
    {
      ...
      port: parseInt(process.env.SHARD_6_PORT || '5438'),
    ...
    },
    {
      ...
      port: parseInt(process.env.SHARD_7_PORT || '5439'),
