...
| 27-01-02 | 01 | 1 | BUN-02 | unit | `bun test packages/core/tests/ffi/hash-fallback.test.ts` | W0 | pending |
| 27-02-01 | 02 | 2 | BUN-02 | integration | `bun test packages/core/tests/ffi/native-hasher-sha512-blake2b.test.ts` | W0 | pending |
| 27-02-02 | 02 | 2 | BUN-01 | integration | `bun test packages/core/tests/runtime/password-adapter.test.ts` | W0 | pending |
| 27-02-03 | 02 | 2 | BUN-01 | integration | `bun test packages/sentinel/tests/hash-manager-argon2id-native.integration.test.ts` | W0 | pending |
...
- [ ] `packages/core/tests/ffi/hash-fallback.test.ts` — behavioral tests for BUN-02 HashFallback sha512/blake2b
- [ ] `packages/core/tests/ffi/native-hasher-sha512-blake2b.test.ts` — stubs for BUN-02 NativeHasher SHA-512/BLAKE2b
- [ ] `packages/core/tests/runtime/password-adapter.test.ts` — integration stubs for BUN-01 argon2id path
- [ ] `packages/sentinel/tests/hash-manager-argon2id-native.integration.test.ts` — integration test for BUN-01 HashManager argon2id native path
