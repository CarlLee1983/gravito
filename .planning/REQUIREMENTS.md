...
- [x] **TYPE-02**: Container.make() 新增 ServiceMap-keyed overload，回傳具體型別而非 any

### 文件與工具

- [x] **DOC-01**: Biome noExplicitAny 從 warn 升級為 error
- [x] **DOC-02**: Biome 新增 noConsole 規則（scope 限 packages/core/src/）
