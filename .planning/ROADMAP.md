...
- [ ] 26-03-PLAN.md — publint CI gate with Turbo pipeline and per-package scripts (DOC-03)
- [ ] 26-04-PLAN.md — README API corrections, orbit/register/use guide, JSDoc English unification (DOC-04, DOC-05, DOC-06, DOC-07)
...
| 26. Documentation and Tooling | v2.1.0 | 0/4 | Not started | - |
