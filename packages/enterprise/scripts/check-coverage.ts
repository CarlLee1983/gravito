...
if (rounded < threshold) {
  console.error(
    `enterprise coverage ${rounded}% is below threshold ${threshold}%. Covered lines: ${hit}/${total}.`
  )
  process.exit(1)
}

console.log(`enterprise coverage ${rounded}% (${hit}/${total}) meets threshold ${threshold}%.`)
