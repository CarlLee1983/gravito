...
if (rounded < threshold) {
  console.error(
    `dark-matter coverage ${rounded}% is below threshold ${threshold}%. Covered lines: ${hit}/${total}.`
  )
  process.exit(1)
}

console.log(`dark-matter coverage ${rounded}% (${hit}/${total}) meets threshold ${threshold}%.`)
