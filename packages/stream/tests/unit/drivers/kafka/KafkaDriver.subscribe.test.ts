...
describe('KafkaDriver.subscribe()', () => {
  ...
  describe('Subscribe Initialization', () => {
    ...
    it('should enable notifier when subscribing', async () => {
      ...
      const _subscribePromise = driver2.subscribe('test-queue', callback)
    ...
    it('should start lifecycle manager when subscribing', async () => {
      const callback = mock(async () => {})
      const _subscribePromise = driver.subscribe('test-queue', callback)
  ...
  describe('Callback Execution', () => {
    ...
    it('should enforce callback timeout', async () => {
      ...
      const _subscribePromise = driver.subscribe('test-queue', timeoutCallback, {
        callbackTimeout: 100,
      })
  ...
  describe('Lifecycle Integration', () => {
    ...
    it('should transition to error state on lifecycle error', async () => {
      const callback = mock(async () => {})
      const _errorPromise = new Promise<string>((resolve) => {
  ...
  describe('Error Handling', () => {
    it('should handle callback errors gracefully', async () => {
      ...
      const _subscribePromise = driver.subscribe('test-queue', errorCallback)
    ...
    it('should isolate callback errors from other callbacks', async () => {
      ...
      const _subscribePromise = driver.subscribe('test-queue', callback1)
