...
if (rounded < threshold) {
  console.error(
    `spectrum coverage ${rounded}% is below threshold ${threshold}%. Covered lines: ${hit}/${total}.`
  )
  process.exit(1)
}

console.log(`spectrum coverage ${rounded}% (${hit}/${total}) meets threshold ${threshold}%.`)
