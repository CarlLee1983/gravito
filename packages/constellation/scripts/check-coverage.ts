...
if (rounded < threshold) {
  console.error(
    `constellation coverage ${rounded}% is below threshold ${threshold}%. Covered lines: ${hit}/${total}.`
  )
  process.exit(1)
}

console.log(`constellation coverage ${rounded}% (${hit}/${total}) meets threshold ${threshold}%.`)
