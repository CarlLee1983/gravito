...
優化 `SitemapStream.toXML()` 方法的性能，從字串拼接改為流式/緩衝區處理，大幅提升大型 sitemap 的生成速度。
...
| 方案 | 50K entries | 100K entries | 內存減少 |
|-----|------------|-------------|---------|
| 當前（字串拼接） | 500-1000ms | 2000-4000ms | - |
| 方案 A (Array.join) | 300-600ms | 1200-2400ms | 0% |
| 方案 B (流式) | 250-500ms | 1000-2000ms | 60-80% |
| 方案 C (Buffer) | 200-400ms | 800-1600ms | 40-60% |
