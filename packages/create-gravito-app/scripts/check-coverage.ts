...
if (rounded < threshold) {
  console.error(
    `create-gravito-app coverage ${rounded}% is below threshold ${threshold}%. Covered lines: ${hit}/${total}.`
  )
  process.exit(1)
}

console.log(
  `create-gravito-app coverage ${rounded}% (${hit}/${total}) meets threshold ${threshold}%.`
)
