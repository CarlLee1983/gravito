...
if (rounded < threshold) {
  console.error(
    `freeze-vue coverage ${rounded}% is below threshold ${threshold}%. Covered lines: ${hit}/${total}.`
  )
  process.exit(1)
}

console.log(`freeze-vue coverage ${rounded}% (${hit}/${total}) meets threshold ${threshold}%.`)
