...
if (rounded < threshold) {
  console.error(
    `ripple-client coverage ${rounded}% is below threshold ${threshold}%. Covered lines: ${hit}/${total}.`
  )
  process.exit(1)
}

console.log(`ripple-client coverage ${rounded}% (${hit}/${total}) meets threshold ${threshold}%.`)
