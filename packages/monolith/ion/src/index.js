...
var require_body = __commonJS((exports, module) => {
  ...
  var parseBody = async (request, options = /* @__PURE__ */ Object.create(null)) => {
    ...
    const headers =
      request instanceof import_request.HonoRequest ? request.raw.headers : request.headers
...
var require_hono_base = __commonJS((exports, module) => {
  ...
  class Hono2 {
    ...
    constructor(options = {}) {
      ...
      this.getPath =
        (strict ?? true) ? (options.getPath ?? import_url.getPath) : import_url.getPathNoStrict
    }
    #clone() {
      ...
      app.routes.map((r) => {
        ...
        if (app.errorHandler === errorHandler) {
          ...
          handler = async (c, next) =>
            (await (0, import_compose.compose)([], app.errorHandler)(c, () => r.handler(c, next)))
              .res
          ...
          if (method === import_router.METHOD_NAME_ALL || method === m) {
            routes[m][path2] ||= [
              ...(findMiddleware(middleware[m], path2) ||
                findMiddleware(middleware[import_router.METHOD_NAME_ALL], path2) ||
                []),
            ]
