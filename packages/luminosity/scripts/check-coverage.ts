...
if (rounded < threshold) {
  console.error(
    `luminosity coverage ${rounded}% is below threshold ${threshold}%. Covered lines: ${hit}/${total}.`
  )
  process.exit(1)
}

console.log(`luminosity coverage ${rounded}% (${hit}/${total}) meets threshold ${threshold}%.`)
