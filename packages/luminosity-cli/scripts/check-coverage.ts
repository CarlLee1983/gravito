...
if (rounded < threshold) {
  console.error(
    `luminosity-cli coverage ${rounded}% is below threshold ${threshold}%. Covered lines: ${hit}/${total}.`
  )
  process.exit(1)
}

console.log(`luminosity-cli coverage ${rounded}% (${hit}/${total}) meets threshold ${threshold}%.`)
