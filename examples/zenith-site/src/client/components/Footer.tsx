    ...
    <footer className="border-t border-white/5 py-16 bg-zenith-void relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 font-body">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-3 text-zinc-400 font-heading uppercase italic">
            ...
            <div>
              <span className="font-black text-white block tracking-widest text-lg">ZENITH</span>
              <span className="text-[10px] uppercase tracking-widest opacity-50 not-italic font-mono">
                Control Plane
              </span>
            </div>
          </div>
