                    ...
                    <div className="grid lg:grid-cols-2 gap-8 relative">
                        ...
                        >
                            ...
                            <div className="mt-10 flex items-center gap-6">
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-mono text-white/30 uppercase tracking-widest">Mode</span>
                                    <span className="text-zenith-pulse font-bold">TRANSIENT</span>
                                </div>
                                <div className="w-px h-8 bg-white/5" />
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-mono text-white/30 uppercase tracking-widest">Latency</span>
                        ...
                        >
                            ...
                            <div className="mt-10 flex items-center gap-6">
                                ...
                                <div className="w-px h-8 bg-white/5" />
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-mono text-white/30 uppercase tracking-widest">Durability</span>
                        ...
                        <div className="lg:col-span-5 space-y-8">
                            ...
                            <div className="p-8 rounded-3xl bg-black/40 border border-white/10 zenith-glass font-mono">
                                <div className="flex items-center justify-between mb-6">
                                    <span className="text-[10px] text-zenith-accent uppercase tracking-widest font-bold">Protocol_Handshake</span>
...
function MetricDisplay({ value, label, color, accent }: { value: string, label: string, color: string, accent: string }) {
    return (
        <div className="text-center space-y-4">
            <div className={`text-5xl lg:text-7xl font-mono font-bold ${color} tracking-tighter text-glow mb-2`}>
                {value}
            </div>
