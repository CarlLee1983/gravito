...
export default function Features() {
  ...
  return (
    <div className="min-h-screen bg-zenith-void text-white selection:bg-zenith-accent selection:text-zenith-void overflow-x-hidden font-sans">
      ...
      <section className="relative pt-40 pb-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-black tracking-tight mb-8 leading-tight font-heading uppercase italic">
            ...
            <p className="text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed font-medium font-body">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 font-body">
          <div className="flex flex-col md:flex-row items-center gap-12 mb-20">
            <div className="flex-1">
              <h2 className="text-4xl font-black mb-6 tracking-tight font-heading uppercase italic">
            ...
            <div className="flex-none flex items-center gap-4 text-xs font-mono text-zinc-500">
          ...
          <div className="grid lg:grid-cols-2 gap-8 relative">
            ...
            <motion.div
              whileHover={{ y: -5, borderColor: 'rgba(0, 251, 255, 0.3)' }}
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-4 font-heading uppercase italic">
              ...
              <div className="mt-10 flex items-center gap-6">
                <div className="flex flex-col">
                  ...
                  <span className="text-zenith-pulse font-bold uppercase tracking-wider">
                    TRANSIENT
                  </span>
                </div>
            ...
            >
              ...
              <div className="mt-10 flex items-center gap-6">
                <div className="flex flex-col">
                  ...
                  <span className="text-zenith-stellar font-bold uppercase tracking-wider">
                    PERSISTENT
                  </span>
                </div>
                <div className="w-px h-8 bg-white/5" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <h2 className="text-4xl font-black tracking-tight font-heading uppercase italic">
                {trans('features_deep.protocol.title')}
              </h2>
              <p className="text-zinc-400 text-lg font-medium leading-relaxed font-body">
              ...
              <div className="p-8 rounded-3xl bg-black/40 border border-white/10 zenith-glass font-mono">
                ...
                <div className="space-y-3 text-[12px] text-zinc-500">
                  <div className="flex justify-between">
                    ...
                    <span className="text-emerald-500 font-bold">ACK_OK</span>
                  </div>
                  <div className="flex justify-between">
                    <span>&gt; ENCRYPTION_INIT</span>
                    <span className="text-emerald-500 font-bold">CIPHER_READY</span>
                  </div>
                  <div className="flex justify-between">
                    <span>&gt; STREAM_SYNC</span>
                    <span className="text-zenith-accent font-bold">LINKED_STABLE</span>
                  </div>
                </div>
              </div>
            </div>

            <div className="lg:col-span-7 grid sm:grid-cols-2 gap-6 font-body">
              <ProtocolFeature
      ...
      <section className="py-32 relative font-heading">
          ...
          <div className="zenith-glass-strong rounded-[3rem] p-16 border border-white/10 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="text-center mb-16">
                <h2 className="text-sm font-mono tracking-[0.4em] uppercase text-zinc-500 mb-4 font-black italic">
...
function ProtocolFeature({
  ...
  return (
    ...
    >
      <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-zinc-400 mb-6 group-hover:text-zenith-accent group-hover:bg-zenith-accent/10 transition-all border border-white/5 group-hover:border-zenith-accent/20">
        {icon}
      </div>
