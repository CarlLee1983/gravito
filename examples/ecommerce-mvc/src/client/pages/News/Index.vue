...
const getCategoryBadgeClass = (category: string) => {
  switch (category) {
    case 'promotion': return 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400'
    case 'new_arrival': return 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400'
