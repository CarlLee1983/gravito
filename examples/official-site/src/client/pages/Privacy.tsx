...
import { Shield, Sparkles, Fingerprint, Lock } from 'lucide-react'
                ...
                <div className="max-w-4xl mx-auto px-6 relative z-10">
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="group p-8 rounded-[2rem] bg-white/[0.02] border border-white/5 backdrop-blur-3xl hover:border-singularity/30 transition-all duration-500">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-2xl font-bold tracking-tight text-white">
                                    {trans('legal.privacy.section1.title')}
                                </h2>
                            </div>
                            <p className="text-gray-400 leading-relaxed text-lg">
                                {trans('legal.privacy.section1.content')}
                            </p>
                        </div>
                        ...
                        <div className="group p-8 rounded-[2rem] bg-white/[0.02] border border-white/5 backdrop-blur-3xl hover:border-singularity/30 transition-all duration-500">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-2xl font-bold tracking-tight text-white">
                                    {trans('legal.privacy.section2.title')}
                                </h2>
                            </div>
                            <p className="text-gray-400 leading-relaxed text-lg">
                                {trans('legal.privacy.section2.content')}
                            </p>
                        </div>
                        ...
                        <div className="group p-8 rounded-[2rem] bg-white/[0.02] border border-white/5 backdrop-blur-3xl hover:border-singularity/30 transition-all duration-500">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-2xl font-bold tracking-tight text-white">
                                    {trans('legal.privacy.section3.title')}
                                </h2>
                            </div>
                            <p className="text-gray-400 leading-relaxed text-lg">
                                {trans('legal.privacy.section3.content')}
                            </p>
                        </div>
                        ...
                        <div className="group p-8 rounded-[2rem] bg-white/[0.02] border border-white/5 backdrop-blur-3xl hover:border-singularity/30 transition-all duration-500">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-2xl font-bold tracking-tight text-white">
                                    {trans('legal.privacy.section4.title')}
                                </h2>
                            </div>
                            <p className="text-gray-400 leading-relaxed text-lg">
                                {trans('legal.privacy.section4.content')}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mt-20 p-8 rounded-[2rem] bg-singularity/5 border border-singularity/10 text-center">
                        <p className="text-sm font-mono text-singularity uppercase tracking-widest">
                            Secure Protocol Active // {new Date().getFullYear()}
                        </p>
                    </div>
                </div>
            </section>
