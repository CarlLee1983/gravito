...
import { Cpu, Zap, Activity, Shield, Code, Layers, Share2, Terminal } from 'lucide-react'
                    ...
                    >
                        ...
                        <div className="mt-12 p-8 rounded-[32px] bg-white/[0.02] border border-white/5 backdrop-blur-sm relative overflow-hidden group">
                            ...
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <span className="text-xs font-black text-gray-500 uppercase tracking-widest">PlanetCore Runtime</span>
                            </div>
                        ...
                        {points.map((point, index) => (
                            ...
                            >
                                <div className="flex items-start gap-6">
                                    <div className={`p-4 rounded-xl ${point.color} group-hover:scale-110 transition-transform`}>
                                        <point.icon size={28} />
                                    </div>
                                    <div>
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-12">
                            <div className="flex-1">
                                ...
                                <p className="text-gray-500 max-w-md">
                                    {t.features_page.perf_desc}
                                </p>
                            </div>

                            <div className="flex gap-6 w-full md:w-auto">
                                <div className="flex-1 md:w-40 p-6 rounded-3xl bg-panel/40 border border-white/5 text-center">
                                    <div className="text-4xl font-black text-singularity mb-1">0.08<span className="text-xs ml-1">ms</span></div>
                                    <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">{t.features_page.perf_latency}</div>
                                </div>
                                <div className="flex-1 md:w-40 p-6 rounded-3xl bg-panel/40 border border-white/5 text-center">
                                    <div className="text-4xl font-black text-purple-400 mb-1">1.2<span className="text-xs ml-1">ms</span></div>
                                    <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">{t.features_page.perf_boot}</div>
                                </div>
                                <div className="flex-1 md:w-40 p-6 rounded-3xl bg-panel/40 border border-white/5 text-center">
                                    <div className="text-4xl font-black text-white mb-1">0<span className="text-xs ml-1">kb</span></div>
                                    <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">{t.features_page.perf_deps}</div>
                                </div>
                            </div>
                        </div>
                    </div>
