export default {
  ...
  features: {
    ...
    resilience_subtitle: '容錯防護層',
    resilience_desc:
      '內建熔斷器 (Circuit Breakers)、重試機制與降級方案，確保系統在極端負載下依然穩定。',
    inertia_title: 'Ion',
    ...
    monitor_subtitle: '觀測套件',
    monitor_desc: '內建健康檢查、指標與追蹤，支援 OpenTelemetry。',
    stream_title: 'Stream',
    stream_subtitle: '通用佇列',
    stream_desc: '多驅動背景任務，從 Redis 到 Kafka 彈性切換。',
    stasis_title: 'Stasis',
    stasis_subtitle: '快取與鎖',
    stasis_desc: '快取、限流與分散式鎖定，穩定支撐高併發。',
    astral_title: 'Astral',
    astral_subtitle: '影子契約 (OpenAPI)',
    astral_desc: '無污染的 API 文檔引擎。自動從 DTO 與路由中提取規格。',
    image_title: 'Prism',
    image_subtitle: '性能奇點 (Image)',
    image_desc: '自動處理 CLS、延遲載入與響應式 `srcset`，且具備零客戶端下載負擔。',
    i18n_title: 'Cosmos',
    i18n_subtitle: '全球引力 (I18n)',
    i18n_desc: '原生多語系偵測與路徑路由，具備強大的型別安全翻譯機制。',
    getStarted: '開始使用',
  },
  features_page: {
  ...
  footer: {
    ...
    photon: 'Photon',
    photon_note:
      'Photon (v1.1.0) — 高效能 HTTP 引擎，具備 Proxy-less 上下文調度技術，實現亞微秒級開銷與約 25 倍的屬性存取加速。',
    atlas: 'Atlas (ORM)',
  ...
  about: {
    ...
    queueDesc:
      '一套介面，無限可能。全方位驅動支援的野心：Redis, Amazon SQS, RabbitMQ, Kafka 等。無需更動業務邏輯即可實現基礎設施的無縫遷移。',
    ctaTitle: '準備好進入奇點了嗎？',
