...
const CollectionTeaser = () => {
  ...
  return (
    <section ref={ref} className="relative h-screen w-full overflow-hidden flex items-center justify-center bg-stone-100">
      {/* Background Parallax */}
      <motion.div 
        style={{ scale }}
      ...
      >
        <div 
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1571934811356-5cc55449d0f1?q=80&w=2000&auto=format&fit=crop')" }}
        />
        ...
        <div className="bg-paper-white/90 backdrop-blur-md p-12 md:p-24 shadow-2xl relative overflow-hidden group">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1">
              <span className="font-sans text-xs tracking-[0.3em] text-cinnabar uppercase mb-6 block">The Collection</span>
            ...
            <div className="hidden md:block h-64 border-l border-ink-black/10 pl-12">
               <motion.div style={{ y }} className="writing-vertical-rl font-display text-4xl text-ink-black/20 select-none">
                 一期一會
               </motion.div>
            </div>
          </div>
