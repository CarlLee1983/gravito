    ...
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden bg-ink-black">
      ...
      <motion.div style={{ y: bgY }} className="absolute inset-0 z-0">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1506459225022-777f43e81332?q=80&w=2500&auto=format&fit=crop')",
          }}
        />
        {/* Vignette */}
      ...
      <div className="relative z-10 h-full w-full flex flex-col justify-center items-center">
        ...
        <motion.div style={{ y: textY, opacity }} className="relative mix-blend-overlay">
        ...
        >
          <span className="text-xs font-sans tracking-[0.3em] text-paper-white vertical-rl">
            SCROLL
          </span>
