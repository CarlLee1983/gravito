  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] p-6 md:p-8 flex justify-between items-start pointer-events-none">
        ...
        <Link to="/" className="pointer-events-auto bg-paper-white/80 backdrop-blur-md px-4 py-2 rounded-full border border-ink-black/10 text-xs font-sans tracking-widest uppercase text-ink-black hover:bg-ink-black hover:text-white transition-colors duration-500">
          MIST NANTOU
        </Link>
