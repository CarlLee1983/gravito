...
import { ArrowLeft, Clock, Droplets, Flame, Thermometer, Wind } from 'lucide-react';
...
const ProductDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-ink-black text-paper-white relative selection:bg-paper-white selection:text-ink-black">
      {/* Back Button */}
      <Link to="/shop" className="fixed top-8 left-8 z-50 p-4 rounded-full border border-white/10 bg-black/20 backdrop-blur-md hover:bg-white hover:text-ink-black transition-colors cursor-pointer text-white group">
        ...
        <div className="w-full lg:w-[45%] h-auto lg:h-screen overflow-y-auto p-8 lg:p-24 bg-ink-black border-l border-white/5 relative z-10 no-scrollbar">
          ...
          >
            ...
            <div className="mb-16 bg-white/5 p-8 rounded-lg border border-white/5">
              ...
              <ProfileBar label="SWEETNESS" value={product.profile.sweetness} theme={product.theme} />
              ...
              <ProfileBar label="AFTERTASTE" value={product.profile.aftertaste} theme={product.theme} />
            </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-6 border border-white/10 rounded hover:bg-white/5 transition-colors">
                  <span className="text-xs font-sans tracking-widest text-white/40 block mb-4">GONGFU STYLE</span>
                ...
                {/* Mug Style */}
                <div className="p-6 border border-white/10 rounded hover:bg-white/5 transition-colors">
                  <span className="text-xs font-sans tracking-widest text-white/40 block mb-4">MUG BREW</span>
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-3">
                      <Thermometer className="w-4 h-4 text-white/60" />
