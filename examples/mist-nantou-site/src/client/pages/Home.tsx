...
const Home = () => {
  return (
    <main className="bg-paper-white min-h-screen selection:bg-fir-green selection:text-paper-white">
      <HeroSection />
      
      {/* Placeholder for Section 2 to allow scrolling */}
      <section className="h-screen w-full flex items-center justify-center bg-stone-100">
        <p className="font-body text-ink-black/30 tracking-widest">工藝與葉 (Coming Soon)</p>
      </section>
    </main>
  );
};
