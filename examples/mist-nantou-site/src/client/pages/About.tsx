...
const timeline = [
  {
    year: '1984',
    title: '開墾',
    desc: '林阿公在南投深山種下第一株青心烏龍。那一年，還是手提肩挑的年代。',
  },
  {
    year: '1992',
    title: '獲獎',
    desc: '首次參加鹿谷鄉農會比賽茶，即獲得頭等獎殊榮，奠定製茶工藝基礎。',
  },
  {
    year: '2005',
    title: '轉型',
    desc: '堅持自然農法，停止使用化學除草劑，讓土地休養生息，茶園開始出現螢火蟲。',
  },
  {
    year: '2024',
    title: '新生',
    desc: '第三代返鄉接手，創立「雲霧南投」品牌，將傳統茶藝與現代美學結合。',
  },
]
...
const About = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-ink-black text-paper-white relative selection:bg-paper-white selection:text-ink-black"
    >
      {/* Hero */}
      <section className="h-screen w-full flex items-center justify-center relative overflow-hidden">
        <motion.div
          style={{
            y,
            backgroundImage:
              "url('https://images.unsplash.com/photo-1589362372727-44c33745098e?q=80&w=2000&auto=format&fit=crop')",
          }}
        ...
        >
          <h1 className="text-8xl md:text-[12rem] font-display mb-8 text-paper-white mix-blend-overlay opacity-90">
            職人誌
          </h1>
          <p className="font-sans tracking-[0.5em] opacity-60 uppercase text-sm border-t border-white/20 pt-8 inline-block">
            The Artisans & The Land
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-48 px-8 max-w-4xl mx-auto text-center">
        ...
        <p className="font-body text-2xl md:text-4xl leading-loose font-light text-white/90">
          ...
          而是人與土地的深情對話。
          <br />
          <span className="text-white/40">在雲霧繚繞的南投山區，我們試圖找回</span>
          <br />
        ...
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
          {stats.map((stat) => (
            <div key={stat.label} className="group cursor-default">
              <div className="text-white/40 text-sm font-sans tracking-widest mb-4 group-hover:text-cinnabar transition-colors">
                {stat.label}
              </div>
          ...
          <div className="flex flex-col gap-8 group">
            <div className="aspect-[16/9] w-full bg-stone-800 relative overflow-hidden">
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://images.unsplash.com/photo-1523996767426-62da472d822d?q=80&w=1000&auto=format&fit=crop')",
                }}
              />
              <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors duration-500" />
              <div className="absolute bottom-8 left-8 border border-white/20 px-6 py-3 font-display text-xl bg-black/30 backdrop-blur-md">
                製茶師 — 林阿公
              </div>
            </div>
          ...
          <div className="flex flex-col gap-8 group">
            <div className="aspect-[16/9] w-full bg-stone-800 relative overflow-hidden">
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://images.unsplash.com/photo-1543255006-d6395b6f1171?q=80&w=1000&auto=format&fit=crop')",
                }}
              />
              <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors duration-500" />
              <div className="absolute bottom-8 left-8 border border-white/20 px-6 py-3 font-display text-xl bg-black/30 backdrop-blur-md">
        ...
        <div className="max-w-4xl mx-auto px-8 relative">
          ...
          <div className="flex flex-col gap-24">
            {timeline.map((event, i) => (
              <div
                key={event.year}
                className={`flex flex-col md:flex-row gap-8 md:gap-24 relative ${i % 2 === 0 ? '' : 'md:flex-row-reverse'}`}
              >
                <div className="w-full md:w-1/2 text-left md:text-right">
                  <span className="text-6xl font-display text-white/10 absolute -top-8 left-0 md:left-auto md:right-0 z-0 select-none">
                    {event.year}
                  </span>
                  <h3 className="text-3xl font-display text-cinnabar relative z-10 mb-4">
                    {event.title}
                  </h3>
                </div>
