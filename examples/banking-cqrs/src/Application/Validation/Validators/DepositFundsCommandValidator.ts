import type { DepositFundsCommand } from '../../Commands/DepositFunds/DepositFundsCommand'
 ...
 */
export class DepositFundsCommandValidator implements CommandValidator<DepositFundsCommand> {
  validate(command: DepositFundsCommand): ValidationResult {
