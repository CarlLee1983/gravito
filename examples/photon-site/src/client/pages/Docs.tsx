        ...
        <header className="max-w-4xl mx-auto mb-32 relative z-10">
          ...
          <div className="flex flex-wrap gap-12 py-10 border-y border-s-brd bg-surf-bg">
            <div className="flex flex-col gap-2">
              <span className="text-[9px] font-bold text-p-txt opacity-40 uppercase tracking-widest">Core_Category</span>
              <span className="text-xs font-bold text-s-txt tracking-widest uppercase">{meta?.category || 'SYSTEM_CORE'}</span>
            </div>
            <div className="flex flex-col gap-2 pl-12 border-l border-s-brd">
              <span className="text-[9px] font-bold text-p-txt opacity-40 uppercase tracking-widest">Est_Complexity</span>
              <span className="text-xs font-bold text-photon-gold tracking-widest uppercase">{meta?.complexity || 'TECHNICAL'}</span>
            </div>
            <div className="flex flex-col gap-2 pl-12 border-l border-s-brd">
              <span className="text-[9px] font-bold text-p-txt opacity-40 uppercase tracking-widest">Protocol_Status</span>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center gap-12 relative z-10">
                    <div>
                      <span className="text-[10px] font-bold text-photon-gold mb-4 block tracking-[0.5em] uppercase">UP_NEXT</span>
                    ...
                    <div className="w-16 h-16 rounded-full border border-s-brd bg-surf-bg flex items-center justify-center group-hover:border-photon-gold/40 group-hover:scale-110 transition-all">
                      <ChevronRight className="text-m-txt group-hover:text-photon-gold transition-colors" size={24} />
                    </div>
                  </div>
                </Link>
              )
