    ...
    <div className="lab-grid p-12 my-32 rounded-sm border border-white/10 group">
      <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
        <div className="flex-1">
          ...
          <h3 className="text-3xl font-black text-white uppercase tracking-tighter">The Stress Lab</h3>
        ...
        >
          {active ? 'SYSTEM_STRESS_ACTIVE' : 'START_SIMULATION'}
        ...
        <div className="space-y-8 bg-black/40 p-8 border border-white/5 relative">
          ...
          <div className="space-y-4">
            <div className="flex justify-between text-[9px] font-technical uppercase">
              <span className="text-photon-gold font-bold">PHOTON_CORE</span>
          ...
          <div className="space-y-4">
            <div className="flex justify-between text-[9px] font-technical uppercase">
              <span className="text-gray-600">GENERIC_ENGINE</span>
          ...
          <div className="pt-8 border-t border-white/5">
            <p className="text-[10px] font-technical text-photon-gold leading-relaxed uppercase">
              {photonRPS > honoRPS ? 
                `// PHOTON IS ${( ((photonRPS / honoRPS) - 1) * 100 ).toFixed(1)}% MORE EFFICIENT AT THIS SCALE` : 
                '// INITIALIZING_COMPARATIVE_STRESS_TEST'
              }
            </p>
          </div>
        </div>
