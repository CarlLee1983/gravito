...
### 1. Request Timeline
View incoming HTTP requests in real-time. Click on any request to replay it exactly as it was sent—useful for reproducing bugs without manually reconstructing payloads.
