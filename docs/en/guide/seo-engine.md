...
Luminosity includes a powerful **RouteScanner** system that automatically discovers routes from various frameworks including **Gravito**, **Hono**, **Express**, **Next.js**, and **Nuxt**.

For complete documentation, see the dedicated [RouteScanner Guide](/en/docs/guide/seo-route-scanner).
