...
|------|-----------|-----------|-----|
| **版本管理** | [Complete] 核心功能 | ❌ 不支援 | ⚠ 需額外配置 |
| **CHANGELOG 生成** | [Complete] 自動生成 | ❌ 不支援 | ⚠ 需額外配置 |
| **構建加速** | ❌ 不支援 | [Complete] 核心功能 | [Complete] 核心功能 |
| **遠端快取** | ❌ 不支援 | [Complete] 支援 | [Complete] 支援 |
| **任務管道** | ❌ 不支援 | [Complete] 支援 | [Complete] 支援 |
| **依賴圖分析** | ❌ 不支援 | ⚠ 基礎支援 | [Complete] 完整支援 |
| **代碼生成** | ❌ 不支援 | ❌ 不支援 | [Complete] 支援 |
| **影響分析** | ❌ 不支援 | ⚠ 基礎支援 | [Complete] 完整支援 |
| **Bun 支援** | [Complete] 完全支援 | [Complete] 完全支援 | ⚠ 部分支援 |
| **TypeScript 優先** | [Complete] 是 | [Complete] 是 | [Complete] 是 |
