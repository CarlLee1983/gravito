...
describe('AdManagementContext', () => {
  ...
  describe('action=activate', () => {
    it('應啟用廣告並保存', async () => {
      ...
      const result = await ctx.execute({ adId: 'ad-draft', action: 'activate' })
  ...
  describe('action=pause', () => {
    it('應暫停廣告並保存', async () => {
      ...
      await repo.save(ad)
      const ctx = new AdManagementContext(repo, core)
      const result = await ctx.execute({ adId: 'ad-active', action: 'pause' })
      expect(result).toBeDefined()
  ...
  describe('action=delete', () => {
    it('應刪除廣告', async () => {
      ...
      await repo.save(ad)
      const ctx = new AdManagementContext(repo, core)
      const result = await ctx.execute({ adId: 'ad-delete', action: 'delete' })
